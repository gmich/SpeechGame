...
namespace SpeechGame.Level
{
    ...
    public class TileMap
    {
        ...
        public void Randomize(int mapWidth, int mapHeight)
        {
            ...
            {
                if (rand.Next(0, 15) == 1)
                    effectsManager.AddBlock(new Vector2(x*TileWidth,0), new Rectangle(0, 0, rand.Next(30,50), rand.Next(60,130)));
        ...
        public bool CellIsBlocked(Vector2 cell,bool destructive)
        {
            return effectsManager.LocationIsBlocked(cell, destructive);
        }
